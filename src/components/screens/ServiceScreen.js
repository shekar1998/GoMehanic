...
const ServiceScreen = () => {
  ...
  const DYNAMIC_CAR_IMAGES = require('../assets/Car.png'); 
  const CAR_WASHING_IMG=require('../assets/CarWash.jpg');
  ...
  const LoadImage=(image)=>{  
      return (
            <Box style={styles.imageContainer}>
              <Image source={DYNAMIC_CAR_IMAGES} style={styles.ImgBg} alt="carImg"/>              
            </Box>
            );  
  }
